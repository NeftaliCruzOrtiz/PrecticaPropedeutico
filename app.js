...
function handleClick() {
    ...
    // Mostramos el valor en el parrafo del HTML
...
// Agrgamos el evento 'blur' al campo de texto y le asignamos una función arrow anónima como callback
inputText.addEventListener("blur", () => {
    // Obtenemos al valor del campo de texto
    const texto = inputText.value;
